      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-8 md:gap-12">
          ...
          <div className="lg:w-1/2 text-center lg:text-left">
            ...
            >
              <span className="text-[#07A8ED]">BanglaCoder</span> - {typedText}
          ...
          <div className="lg:w-1/2 mt-8 lg:mt-0 w-full">
            ...
            >
              ...
              <div className="p-4 sm:p-6 font-mono text-xs sm:text-sm">
                ...
                <div className="text-[#E5E7EB] mb-3 sm:mb-4">
                  <span className="text-[#07A8ED]">import</span> {`{ BanglaCoderLogo }`} <span className="text-[#07A8ED]">from</span> <span className="text-[#F59E0B]">'./components'</span>
                </div>
                <div className="text-[#E5E7EB] mb-3 sm:mb-4">
                ...
                <div className="text-[#E5E7EB] ml-12 mb-3 sm:mb-4">
                  <span className="text-[#F472B6]">&lt;BanglaCoderLogo</span> <span className="text-[#F472B6]">/&gt;</span>
                </div>
                <div className="text-[#E5E7EB] ml-12 mb-3 sm:mb-4">
